...
Shader "Shader Forge/Examples/Custom Lighting" {
    Properties {
        ...
        _Gloss ("Gloss", Range(0, 1)) = 0.3662691
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
